...
2. [Sending 1,000 Epic to new wallet addresses.](#option2)
...
### Send 1,000 EPIC to New Addresses

Just like setting up a standard MN. Send exactly 1,000 EPIC to each new address created above.
...
*Please note, the masternode private key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 1,000 EPIC on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the epic github repo](https://github.com/epic/epic/blob/master/doc/masternode_conf.md)
