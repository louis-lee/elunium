...
high-powered mining hardware. Epic utilizes an energy efficient proof-of-stake algorithm, 
...
Epic Core is the original Epic client and it builds the backbone of the network.
However, it downloads and stores the entire history of Epic transactions;
