...
In order to support loading of multiple wallets in epic-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is epic.cpp.
...
Changes to epic.cpp
----------------------
epic.cpp is the entry point into epic-qt, and as such, will require some minor modifications to provide hooks for
